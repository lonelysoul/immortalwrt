...
DEPENDENCIES=(
  ...
  gettext gcc-multilib g++-multilib git libgnutls28-dev gperf haveged help2man intltool
  ...
  libreadline-dev libssl-dev libtool lld llvm lrzsz genisoimage msmtp nano ninja-build
